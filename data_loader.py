...
class Generator(object):
    def __init__(self, test_mode=False):
        ...
        if not self.test_mode:
            ...
            with open("/home/vsw1/data/TuSimple/train_set/label_data_0313.json") as f:
                while True:
                    line = f.readline()
                    if not line:
                        break
    ...
    def Generate(self): 
        ...
        for start, end in cuts:
            ...
            self.inputs, self.target_lanes, self.target_h, self.test_image = np.array(inputs), target_lanes, target_h, np.rollaxis(test_image, axis=2, start=0)
    ...
    #################################################################################################################
    ## Generate test data : resize original image to 512*256 and matching correspond points
    #################################################################################################################
